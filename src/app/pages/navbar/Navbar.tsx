...
export default function Navbar() {
  return (
    <div className=" mx-auto items-center  justify-center fixed top-0 left-0 right-0  z-50">
      <nav className="max-w-7xl mx-auto items-center rounded-lg justify-center bg-gray-400/20 pr-4 ">
        <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row gap-3 font-medium text-white">
